...
test("keeps the responsive right panel default within useful limits", () => {
  assert.equal(getDefaultRightPanelWidth(700), 240);
  assert.equal(getDefaultRightPanelWidth(1366), 240);
  assert.equal(getDefaultRightPanelWidth(1920), 240);
  assert.equal(getDefaultRightPanelWidth(1366, { fileOpen: true }), 437);
  assert.equal(getDefaultRightPanelWidth(1920, { fileOpen: true }), 520);
});
