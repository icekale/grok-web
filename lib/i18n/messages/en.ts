...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "memory.description": "Grok cross-session memory files under ~/.grok/memory.",
    ...
    "memory.noPreview": "Select a file to preview.",
    "memory.envOverride": "GROK_MEMORY in the process environment overrides this file until it is unset.",
    "hooks.description": "Grok hook files from inspect. User hooks live in ~/.grok/hooks.",
    "hooks.trust": "Trust project",
    "hooks.untrust": "Untrust project",
    "hooks.add": "Add hook",
    "hooks.reload": "Reload",
    "hooks.remove": "Remove",
    "hooks.event": "Event",
    ...
    "hooks.empty": "No hooks discovered for this directory.",
    "hooks.group.global": "Global",
    "hooks.group.project": "Project",
    "hooks.group.plugin": "Plugin",
    "hooks.group.config": "Config",
    "hooks.group.unknown": "Other",
    "common.vision": "Vision",
    "common.settings": "Settings",
    "settings.categories": "Settings categories",
    "settings.grokTools": "Skills, plugins, hooks, and MCP",
    ...
    "runtime.nav": "Agent Runtime",
    "runtime.title": "Agent Runtime",
    "runtime.description": "Global Grok Build runtime profile · detected {version}",
    "runtime.agent": "Agent",
    "runtime.agentDefault": "Default",
    "runtime.agentProfilePath": "Agent profile path",
    "runtime.agentProfilePlaceholder": "Trusted absolute path",
    "runtime.sandbox": "Sandbox",
    "runtime.maxTurns": "Max turns",
    "runtime.rules": "Rules",
    "runtime.allow": "Allow rules",
    "runtime.deny": "Deny rules",
    "runtime.disableWebSearch": "Disable Web Search",
    "runtime.disableSubagents": "Disable Subagents",
    "runtime.apply": "Apply and safely restart",
    "runtime.confirmRestart": "Apply Runtime Profile and safely restart Grok?",
    "remote.nav": "Remote access",
    "remote.title": "Remote access",
    "remote.description": "Set a password and allow LAN access. A phone on the same Wi-Fi can open the URLs below.",
    "remote.warning": "A device on your LAN is a full operator of this machine. Do not put Grok Web on the public internet over HTTP.",
    "remote.listen": "Listen address",
    "remote.listenDescription": "Current process bind. Changing LAN access needs a restart.",
    "remote.lanEnable": "Allow LAN access",
    "remote.lanOn": "Listening on the local network.",
    "remote.lanOff": "Listening on loopback only.",
    "remote.restartRequired": "Saved, but restart Grok Web to apply the listen address.",
    "remote.copy": "Copy",
    "remote.copied": "Copied",
    "remote.urls": "Addresses",
    "remote.urlsLanHint": "No LAN IPv4 yet; stay on Wi-Fi.",
    "remote.advancedHosts": "Advanced: reverse-proxy hostnames",
    "remote.savedRestartHint": "Settings saved. Restart Grok Web to apply the listen address.",
    ...
    "remote.passwordDescription": "HTTP Basic Auth username is {username}. Required for LAN access or allowed hostnames.",
    ...
    "remote.help": "Open a loopback or LAN URL on the same Wi-Fi. For a reverse proxy, forward to {address}, preserve the Host header, terminate TLS at the proxy, and disable response buffering so the event stream stays live.",
    ...
    "remote.error.password_required": "A password is required to allow LAN access or hostnames.",
    ...
    "sidebar.restoreCodeInWorktree": "Restore code in new worktree",
    "sidebar.restoreCodeMenu": "Restore code",
    "sidebar.restoreCode": "Restore",
    "sidebar.restoreCodeCopy": "The original project and session stay untouched. A new ACP-owned worktree will be created.",
    ...
    "chat.activityGroup.search": "{count} searches",
    "chat.activityGroup.bash": "{count} commands",
    "chat.activityGroup.edit": "{count} edits",
    "chat.activityGroup.read": "{count} files",
    ...
    "chat.commandHooks": "Open hooks",
    "chat.commandMemory": "Open memory",
    "chat.commandRemember": "Save a memory note",
