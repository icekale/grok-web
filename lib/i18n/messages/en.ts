...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "memory.flushTui": "Session flush stays in the Grok TUI until ACP lists /flush.",
    ...
    "hooks.ungated": "Folder-trust is disabled, so project hooks, MCP, and LSP are ungated.",
