...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "remote.nav": "远程访问",
    "remote.title": "远程访问",
    "remote.description": "为已有反向代理绑定精确主机名并设置密码。Grok Web 仍然只监听本机回环地址。",
    "remote.warning": "把域名暴露出去等于把能在本机跑工具的智能体暴露出去。请在反向代理上终止 HTTPS。不要用明文 HTTP 把 Grok Web 放到公网。",
    "remote.listen": "监听地址",
    ...
    "models.accounts": "账户",
    "models.pageSubtitle": "Grok 账号和当前对话使用的模型",
    "models.liveChat": "Grok 模型",
    "models.liveChatHint": "当前对话用的就是这份 Grok ACP 列表。",
    "models.liveEffort": "Effort：{levels}",
    "models.customProviders": "自定义供应商",
    "models.customProvidersHint": "可导入和探测 OpenAI 兼容供应商。这不会改变当前对话的模型列表。",
