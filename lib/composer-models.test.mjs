...
import { composerModelLabel, defaultGrokEffortLevel, mergeComposerModels, visibleGrokEffortLevels } from "./composer-models.ts";
...
test("an existing Grok table reuses its id so cpa grok-4.6 is usable without hiding grok-4.5", () => {
...
test("overlay remaps official Grok efforts onto the Settings provider key", () => {
  ...
  assert.deepEqual(merged.thinkingLevels["cpa:grok-4.6"], ["xhigh", "high", "medium", "low"]);
  assert.equal(merged.thinkingLevelPins["cpa/grok-4.6"], "xhigh");
