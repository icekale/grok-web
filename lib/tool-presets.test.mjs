...
test("hides the composer tool chip unless ACP advertised tools", () => {
  assert.equal(composerShowsToolPreset(true), true);
  assert.equal(composerShowsToolPreset(false), false);
});
