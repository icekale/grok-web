...
const passwordEnabled = Boolean(process.env.GROK_WEB_PASSWORD);
...
if (!loopbackHostnames.has(hostname)) {
  if (passwordEnabled) {
    ...
    console.error(
      `pi-web refuses to listen on ${hostname} without authentication. Set GROK_WEB_PASSWORD or bind 127.0.0.1.`,
    );
    process.exit(1);
  }
}
