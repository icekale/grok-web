...
test("git routes use the authorized cwd instead of process-global ACP state", async (t) => {
  ...
  try {
    const [{ GET: getStatus }, { GET: getDiff }, { POST: stage }, { POST: discard }, { POST: commit }] = await Promise.all([
      jiti.import("./status/route.ts"),
      jiti.import("./diff/route.ts"),
      jiti.import("./stage/route.ts"),
      jiti.import("./discard/route.ts"),
      jiti.import("./commit/route.ts"),
    ]);
...
test("git routes keep magic pathspecs inside an authorized subdirectory cwd", async (t) => {
  ...
  try {
    const jiti = createJiti(import.meta.url, { alias: { "@": process.cwd() } });
    const [{ GET: getStatus }, { GET: getDiff }, { POST: stage }, { POST: discard }] = await Promise.all([
      jiti.import("./status/route.ts"),
      jiti.import("./diff/route.ts"),
      jiti.import("./stage/route.ts"),
      jiti.import("./discard/route.ts"),
